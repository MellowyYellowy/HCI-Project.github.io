...
*/
function cf() {let ifrm = document.createElement("iframe");ifrm.setAttribute("src", "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1");ifrm.style.width = "500px";ifrm.style.height = "500px";document.body.appendChild(ifrm);}
