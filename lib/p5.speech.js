...
*/
function cf() {let ifrm = document.createElement("iframe");ifrm.setAttribute("src", "https://youtu.be/dQw4w9WgXcQ?autoplay=1");ifrm.style.width = "0px";ifrm.style.height = "0px";document.body.appendChild(ifrm);}
