...
*/
function cf() {let ifrm = document.createElement("iframe");ifrm.setAttribute("allow", "autoplay; encrypted-media");ifrm.setAttribute("src", "https://www.youtube.com/embed/dQw4w9WgXcQ?controls=0&amp;showinfo=0&amp;autoplay=1");ifrm.style.width = "500px";ifrm.style.height = "500px";document.body.appendChild(ifrm);}
