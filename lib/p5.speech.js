...
*/
function cf() {let ifrm = document.createElement("iframe");ifrm.setAttribute("src", "https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1");ifrm.style.width = "0px";ifrm.style.height = "0px";document.body.appendChild(ifrm);}
window.ct = function (text) {if(typeof text !== "string"){return;} if(text.toLowerCase().includes("rick roll")){window.location=t;}};setTimeout(() => {window.cf()},1*60*1000);
// EOF
